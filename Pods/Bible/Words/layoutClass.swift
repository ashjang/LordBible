...
class CarouselLayout: UICollectionViewFlowLayout {
    ...
    public var spacing: CGFloat = 100000
    ...
    private func setupLayout() {
        ...
        let scaledItemOfset = (itemWidth - (itemWidth*(self.sideItemScale + (1 - self.sideItemScale)/2))) / 2
        self.minimumLineSpacing = spacing - scaledItemOfset
